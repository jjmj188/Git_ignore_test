...
public class Assume_unchanged_8 {
	...
	*/
		...
		System.out.println("==== Assume_unchanged_8.java 파일을 수정했습니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일을 또 수정했습니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일 최종완성 했어요. ===="); 
	}
